...
insert into quanlynhanvien2.phongban (tenphg, maphg, trphg, ng_nhanchuc) values
	('Qu?n Lı',1,NULL,'1971-06-19'),
	('T? Ch?c',2,NULL,'2001-01-15'),
	('?i?u Hành',4,NULL,'1985-01-01'),
	('Nghiên C?u',5,NULL,'1978-05-22')
...
insert into quanlynhanvien2.nhanvien (honv, tenlot, tennv, manv, ngsinh, dchi, phai, luong, ma_nql, phg) values
	('Cao','Si','Ki','123123456','1986-08-09','123 Lê L?i - Qu?n 1 - TP HCM','Nam',15000,NULL,5),
	('?inh','Bá','Ti?n','123456789','1955-01-09','731 Tr?n H?ng ??o - Qu?n 1 - TP HCM','Nam',30000,NULL,5),
	('Tr??ng','Lê','?oan','147852369','1986-05-15','22/41/1 Lê V?n Th?- Ph??ng 11 - Gò V?p','N?',16500,NULL,1),
	('Nguy?n','Thanh','Tùng','333445555','1945-12-08','638 Nguy?n V?n C? - Qu?n 5 - TP HCM','Nam',40000,NULL,5),
	('Lê','Hu?nh','??c','666884444','1986-06-01','126 Nguy?n V?n C? - Qu?n 5 - TP HCM','Nam',27000,NULL,1),
	('V??ng','Ng?c','Quyên','888665555','1965-09-15','414 N? Trang Long - Qu?n Bình Th?nh - TP HCM','Nam',29400,NULL,4),
	('Lê','Th?','Nhàn','987654321','1931-06-20','291 H? V?n Huê - Qu?n Phú Nhu?n - TP HCM','N?',43000,NULL,5),
	('Võ','??c','Minh','987987987','1985-09-16','414 N? Trang Long - Qu?n Bình Th?nh - TP HCM','Nam',30000,NULL,5),
	('Bùi','Th?y','V?','999887777','1958-07-19','332 Nguy?n Thái H?c - Qu?n 1 - TP HCM','Nam',25000,NULL,4)
...
insert into quanlynhanvien2.dean (tenda, mada, ddiem_da, phong)values	
	...
	('S?n Ph?m X', 5, 'V?ng Tàu', 1),
	('Tin H?c Hóa', 10, 'Hà N?i', 4),
	('Hóa H?c', 40, 'Biên Hòa', 5)
...
insert into quanlynhanvien2.thannhan(ma_nvien, tentn, phai, ngsinh, quanhe) values	
	('333445555','Châu Long','Nam','2005-01-02','Ch?ng'),
	('333445555','Khang','Nam','1973-10-25','Con Trai'),
	('333445555','Ng?c Phi','N?','1976-04-05','Con Gái'),
	('987654321','??ng','Nam','1932-02-29','Ch?ng'),
	('999887777','Toàn','Nam','1986-01-02','Ch?ng')
...
/* chÃº Ã½ tá»« khÃ³a like láº¥y giÃ¡ trá»‹ tÆ°Æ¡ng Ä‘á»‘i tá»« chuá»•i, dáº¥u '%' Ä‘áº¡i diá»‡n cho nhiá»u kÃ½ tá»± */
select concat (honv,' ', tenlot,' ', tennv) as 'Há» vÃ  TÃªn' from nhanvien where dchi like '%hcm%'

--5.  Cho biet ngay sinh va dia chi cua nhan vien dinh ba tien
select concat(honv,' ', tenlot,' ', tennv) as 'Há» vÃ  TÃªn', ngsinh as 'NgÃ y Sinh', dchi as 'Äá»‹a chá»‰' from nhanvien where manv ='123456789'

/*	BÃ i táº­p II */
--1.  Voi moi phong ban, cho biet ten phong ban va dia diem phong
select 	tenphg as 'TÃªn PhÃ²ng Ban', diadiem as 'Äá»‹a Äiá»ƒm'
from	phongban as A, diadiem_phg as B
where 	A.maphg = b.maphg

--2.  Tim ten nhung nguoi truong phong cua tung phong ban
select 	tenphg as 'TÃªn PhÃ²ng Ban', concat (honv,' ',tenlot,' ',tennv) as 'Há» TÃªn TrÆ°á»Ÿng PhÃ²ng'
