...
alter table ddiem_phg add constraint fk_phongban_ddiem_phg foreign key (maphg) references phongban(maphg)
...
alter table nhanvien add constraint fk_nhanvien_nhanvien foreign key (manv) references nhanvien(ma_nql)
...
insert into quanlynhanvien2.nhanvien (honv, tenlot, tennv, manv, ngsinh, dchi, phai, luong, ma_nql, phg) values
	('Cao','Si','Ki','123123456','1986-08-09','123 Lê Lợi - Quận 1 - TP HCM','Nam',15000,'123456789',5),
	('Đinh','Bá','Tiến','123456789','1955-01-09','731 Trần Hưng Đạo - Quận 1 - TP HCM','Nam',30000,'123456789',5),
	('Trương','Lê','Đoan','147852369','1986-05-15','22/41/1 Lê Văn Thọ- Phường 11 - Gò Vấp','Nữ',16500,'147852369',1),
	('Nguyễn','Thanh','Tùng','333445555','1945-12-08','638 Nguyễn Văn Cừ - Quận 5 - TP HCM','Nam',40000,'123456789',5),
	('Lê','Huỳnh','Đức','666884444','1986-06-01','126 Nguyễn Văn Cừ - Quận 5 - TP HCM','Nam',27000,'666884444',1),
	('Vương','Ngọc','Quyên','888665555','1965-09-15','414 Nơ Trang Long - Quận Bình Thạnh - TP HCM','Nam',29400,'999887777',4),
	('Lê','Thị','Nhàn','987654321','1931-06-20','291 Hồ Văn Huê - Quận Phú Nhuận - TP HCM','Nữ',43000,'123456789',5),
	('Võ','Đức','Minh','987987987','1985-09-16','414 Nơ Trang Long - Quận Bình Thạnh - TP HCM','Nam',30000,'123456789',5),
	('Bùi','Thụy','Vũ','999887777','1958-07-19','332 Nguyễn Thái Học - Quận 1 - TP HCM','Nam',25000,'123456789',4)
...
insert into quanlynhanvien2.phancong (ma_nvien, soda)values	
	('123123456', 2, 1),
	('123123456', 40, 2),
	('123456789', 40, 3),
	('147852369', 40, 4),
...
insert into (ma_nvien, tentn, phai, ngsinh, quanhe)values	
